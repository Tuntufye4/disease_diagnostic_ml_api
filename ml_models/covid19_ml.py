...
# 1) Load dataset
# -------------------------
CSV_PATH = "covid19_symptoms.csv"  # Update path if needed
...
# -------------------------
MODEL_FILE = "covid19_pipeline.joblib"
...
# print("Prediction:", pred, "Probability of COVID-19:", proba)
