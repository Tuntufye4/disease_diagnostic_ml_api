...
plt.ylabel("Symptom")
plt.title("Feature Importance in Diabetes Diagnostics")
plt.show()

# 9. Save the model
joblib.dump(model, "diabetes_diagnostics_model.joblib")
print("Model saved as diabetes_diagnostics_model.joblib")
